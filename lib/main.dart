...
// import 'package:on_boarding/ui/pizza/pizza_screen.dart';
...
//   @override
//   Widget build(BuildContext context) {
//     return const MaterialApp(home: PizzaCounterScreen());
//   }
// }

import 'package:flutter/material.dart';

import 'package:on_boarding/ui/local/local_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const MaterialApp(home: LocalScreen());
  }
}
